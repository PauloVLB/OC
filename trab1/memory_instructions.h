...
SC_MODULE(imem) {
	...
	SC_CTOR(imem){
		...
		/// Instructions
		//            V----VV---VV---VV---VV---VV----V  // addi $reg1, $zero, 0
		memory[0] = 0b00001000000000010000000000000000; // 000010 (addi) 00000 ($zero)  00001 ($reg1)  1 (0000000000000001)

		//            V----VV---VV---VV---VV---VV----V  // addi $reg2, $zero, 10
		memory[1] = 0b00001000000000100000000000001010; // 000010 (addi) 00000 ($zero)  00010 ($reg2)  10 (0000000000001010)
		...
		memory[3] = 0b00000000000000000000000000000000;
		memory[4] = 0b00000000000000000000000000000000;
		memory[5] = 0b00000000000000000000000000000000;

		memory[6] = 0b00000000000000000000000000000000; // ENQUANTO

		//            V----VV---VV---VV---VV---VV----V  // addi $reg1, $reg1, 1
		memory[7] = 0b00001000001000010000000000000001; // 000010 (addi) 00000 ($zero)  00001 ($reg1)  1 (0000000000000001)
		
		memory[8] = 0b00000000000000000000000000000000;
		memory[9] = 0b00000000000000000000000000000000;
		memory[10] = 0b00000000000000000000000000000000;
		memory[11] = 0b00000000000000000000000000000000;

		//            V----VV---VV---VV---VV---VV----V  // add $reg3, $reg3, $reg1
		memory[12] = 0b00000100011000010001100000000000; // 000001 (R-Type) 00011 ($reg3) 00001 ($reg1)  00011 ($reg3) 00000 (shmat) 000000 (funct add)


		memory[13] = 0b00000000000000000000000000000000;
		memory[14] = 0b00000000000000000000000000000000;
		memory[15] = 0b00000000000000000000000000000000;
		memory[16] = 0b00000000000000000000000000000000;

		//             V----VV---VV---VV---VV---VV----V  // beq $reg1, $reg2, FIM
		memory[17] = 0b00010000001000100000000000011001; // 000100 (beq) 00001 ($reg1)  00010 ($reg2)  0000000000000000 (offset)

		memory[18] = 0b00000000000000000000000000000000;
		memory[19] = 0b00000000000000000000000000000000;
		memory[20] = 0b00000000000000000000000000000000;

		//             V----VV---VV---VV---VV---VV----V  // j ENQUANTO
		memory[21] = 0b11111100000000000000000000000110; // 111111 (jump) 0 (00000000000000000000000000) (endereco do jump)

		memory[22] = 0b00000000000000000000000000000000;
		memory[23] = 0b00000000000000000000000000000000;
		memory[24] = 0b00000000000000000000000000000000;

		memory[25] = 0b00000000000000000000000000000000; // FIM
