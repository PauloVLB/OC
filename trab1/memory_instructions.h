...
SC_MODULE(imem) {
	...
	SC_CTOR(imem){
		...
		//             V----VV---VV---VV---VV---VV----V  // bne $reg1, $reg2, ENQUANTO
		memory[17] = 0b00011100001000100000000000000110; // 000100 (beq) 00001 ($reg1)  00010 ($reg2)  0000000000000000 (offset)
		...
		// memory[17] = 0b00000000000000000000000000000000;

		// //             V----VV---VV---VV---VV---VV----V  // j ENQUANTO
		// memory[18] = 0b11111100000000000000000000000110; // 111111 (jump) 0 (00000000000000000000000000) (endereco do jump)

		// memory[19] = 0b00000000000000000000000000000000;
		// memory[20] = 0b00000000000000000000000000000000;
		// memory[21] = 0b00000000000000000000000000000000;
		// memory[22] = 0b00000000000000000000000000000000;

		memory[21] = 0b00000000000000000000000000000000; // FIM
